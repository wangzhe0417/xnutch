...
//  public BaseRobotRules getRobotRulesSet(Protocol protocol, Text url) {
  public BaseRobotRules getRobotRulesSet(Protocol protocol, Text url, CrawlDatum datum) {
    URL u = null;
    try {
...
//    return getRobotRulesSet(protocol, u);
    return getRobotRulesSet(protocol, u, datum);
  }
...
//  public abstract BaseRobotRules getRobotRulesSet(Protocol protocol, URL url);
  public abstract BaseRobotRules getRobotRulesSet(Protocol protocol, URL url, CrawlDatum datum);
  @Override
...
//      BaseRobotRules rules = getRobotRulesSet(null, robotsFile.toURI().toURL());
      BaseRobotRules rules = getRobotRulesSet(null, robotsFile.toURI().toURL(), null);
...
//    public BaseRobotRules getRobotRulesSet(Protocol protocol, URL url) {
      public BaseRobotRules getRobotRulesSet(Protocol protocol, URL url, CrawlDatum datum) {
