...
public interface Nutch {
  ...
  public static final Text PROTOCOL_STATUS_CODE_KEY = new Text(
      "nutch.protocol.code");
  ...
  /**
   * Argument key to specify the location of a directory of segments for the
   * REST endpoints. Similar to the -dir command in the bin/nutch script
   **/
  public static final String ARG_SEGMENTDIR = "segment_dir";
  /**
   * Argument key to specify the location of individual segment for the REST
   * endpoints
   **/
  public static final String ARG_SEGMENT = "segment";

  public static final String IP_KEY = "_ip_";
  public static final Text WRITABLE_IP_KEY = new Text(IP_KEY);

  public static final String ROBOTS_KEY = "_robots_";
  public static final Text WRITABLE_ROBOTS_KEY = new Text(ROBOTS_KEY);
}
