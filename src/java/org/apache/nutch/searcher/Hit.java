...
public class Hit implements Writable, Comparable<Hit> {
  ...
  public void write(DataOutput out) throws IOException {
    ...
    Text.writeString(out, getSortValue().getClass().getName());
    getSortValue().write(out);
    Text.writeString(out, dedupValue);
  }
  ...
  public void readFields(DataInput in ) throws IOException {
    ...
    dedupValue = Text.readString(in);
    new Hit(uniqueKey, sortValue, dedupValue);
  }
